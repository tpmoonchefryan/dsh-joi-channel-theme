...
| Compatibility | DeepSeek Harness web `0.1.7-rc.1` (settings ride the Host `Config` schema plus the client `ctx.configForms` service; incl. the `0.1.1-rc.2` four-layer brand split and `0.1.2-alpha` module-table compatibility) |
